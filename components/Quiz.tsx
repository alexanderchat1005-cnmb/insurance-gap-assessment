...
export default function Quiz({ questions, onComplete, onExit }: QuizProps) {
  ...
  // Each option gets a distinct brand-family background. All feel "valid" —
  // just different moods. Peach = alarmed, teal-pale = neutral, teal-bg = calm.
  const optionColors = [
    "bg-peach-bg border-peach/40 active:bg-peach/20",
    "bg-cream border-teal-pale/50 active:bg-teal-bg",
    "bg-teal-bg border-teal-soft/40 active:bg-teal-pale/30",
  ];
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="h-1 bg-gray-100 mx-4 rounded-full shrink-0 overflow-hidden">
        <div
          className="h-full bg-gradient-to-r from-teal to-teal-mid rounded-full transition-all duration-300 ease-out"
      ...
      {isNewSection && (
        <div className="mx-4 mt-3 px-3 py-2 bg-gradient-to-r from-teal to-teal-mid rounded-lg text-white text-xs font-medium flex items-center gap-2">
