...
export const archetypes: Archetype[] = [
  ...
  },
  {
    ...
    pattern: { life: 18, ci: 30, med: 60, wealth: 50, aware: 32 },
  ...
  },
  {
    ...
    emoji: "🫣",
    tagline: "报告在抽屉里封印着",
    symptoms: `你的健康意识早就觉醒了——科普号能刷到凌晨三点，对每一种结节都有PTSD。但你没去体检，没配重疾，没配医疗。你选择用「不知道」代替「没保障」，仿佛只要不打开那个报告，癌症就不存在。`,
    brokerNote: `焦虑不能治病，重疾+百万医疗能。越早配越便宜，健康告知也越容易过。`,
    soulLabels: ["结节恐惧症", "假装没事", "选择性失明"],
    pattern: { life: 50, ci: 15, med: 18, wealth: 45, aware: 75 },
  ...
  },
  {
    ...
    pattern: { life: 35, ci: 40, med: 32, wealth: 10, aware: 55 },
  ...
  },
  {
    ...
    pattern: { life: 48, ci: 25, med: 25, wealth: 80, aware: 52 },
  ...
  },
  {
    ...
    emoji: "🛡️",
    tagline: "买得多，不一定买得对",
    symptoms: `你是真·保单收藏家——寿险、重疾、医疗、意外、年金、教育金，全家人均5张保单，每份都能一口气说出险种+保额。但仔细一查：重疾重复保了3份，医疗险和百万医疗功能重叠，年金回报率还不如定存。你的问题不是缺保障，是配置太乱，保费花得不值。`,
    brokerNote: `你需要的不是加保，是保单体检+配置优化。把重复的砍掉，缺口的补上，整体保费可能还能降。`,
    soulLabels: ["保单收藏家", "配置错乱", "保费黑洞"],
    pattern: { life: 100, ci: 100, med: 100, wealth: 95, aware: 100 },
